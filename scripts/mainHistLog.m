function h = mainHistLog(x,y,xEdges,yEdges,l,clm,cmap)
...
lC = localSmooth(localSmooth(log10(C+1),l)',l)';

% create the graphics
ax = newplot;
s = surf(xEdges,yEdges,zeros(numY,numX),lC,...
         'EdgeColor','interp',...
         'FaceColor','interp');
% s = surf(xEdges,yEdges,zeros(numY,numX),C,'EdgeColor','interp','FaceColor','interp','edgelighting','flat');
